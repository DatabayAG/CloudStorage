...
$ti->setMaxLength(255);
$ti->setSize(60);
$ti->setInfo(ilCloudStorageNextCloud::getDefaultWebDavPath());
$this->form->addItem($ti);
...
$ti->setMaxLength(255);
$ti->setSize(60);
$ti->setInfo($pl->txt("base_directory_info_ncld"));
$this->form->addItem($ti);
...
$ti->setMaxLength(1024);
$ti->setSize(60);
$ti->setInfo($pl->txt("col_app_url_info_ncld"));
$cb->addSubItem($ti);
...
$ti->setMaxLength(1024);
$ti->setSize(60);
$ti->setInfo(ilCloudStorageNextCloud::getDefaultOAuth2Path());
$ro->addSubItem($ti);
