...
define('UTF8_HANGUL_FIRST', "\xea\xb0\x80" /*_codepointToUtf8( UNICODE_HANGUL_FIRST )*/);
define('UTF8_HANGUL_LAST', "\xed\x9e\xa3" /*_codepointToUtf8( UNICODE_HANGUL_LAST )*/);

define('UTF8_HANGUL_LBASE', "\xe1\x84\x80" /*_codepointToUtf8( UNICODE_HANGUL_LBASE )*/);
define('UTF8_HANGUL_VBASE', "\xe1\x85\xa1" /*_codepointToUtf8( UNICODE_HANGUL_VBASE )*/);
define('UTF8_HANGUL_TBASE', "\xe1\x86\xa7" /*_codepointToUtf8( UNICODE_HANGUL_TBASE )*/);

define('UTF8_HANGUL_LEND', "\xe1\x84\x92" /*_codepointToUtf8( UNICODE_HANGUL_LEND )*/);
define('UTF8_HANGUL_VEND', "\xe1\x85\xb5" /*_codepointToUtf8( UNICODE_HANGUL_VEND )*/);
define('UTF8_HANGUL_TEND', "\xe1\x87\x82" /*_codepointToUtf8( UNICODE_HANGUL_TEND )*/);

define('UTF8_SURROGATE_FIRST', "\xed\xa0\x80" /*_codepointToUtf8( UNICODE_SURROGATE_FIRST )*/);
define('UTF8_SURROGATE_LAST', "\xed\xbf\xbf" /*_codepointToUtf8( UNICODE_SURROGATE_LAST )*/);
define('UTF8_MAX', "\xf4\x8f\xbf\xbf" /*_codepointToUtf8( UNICODE_MAX )*/);
if (!defined('UTF8_REPLACEMENT')) {
    define('UTF8_REPLACEMENT', "\xef\xbf\xbd" /*_codepointToUtf8( UNICODE_REPLACEMENT )*/);
}
...
define('UTF8_FDD0', "\xef\xb7\x90" /*_codepointToUtf8( 0xfdd0 )*/);
define('UTF8_FDEF', "\xef\xb7\xaf" /*_codepointToUtf8( 0xfdef )*/);
define('UTF8_FFFE', "\xef\xbf\xbe" /*_codepointToUtf8( 0xfffe )*/);
define('UTF8_FFFF', "\xef\xbf\xbf" /*_codepointToUtf8( 0xffff )*/);
