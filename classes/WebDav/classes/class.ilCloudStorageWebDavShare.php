...
/**
 * Class ilCloudStorageWebDavShare
 *
...
class ilCloudStorageWebDavShare
{
     ...
     */
    public static function loadFromStdClass(stdClass $std_class) : ilCloudStorageWebDavShare
    {
     ...
     * @return ilCloudStorageWebDavShare
     */
    public static function loadFromArray(array $array) : ilCloudStorageWebDavShare
    {
        $new = new self();
