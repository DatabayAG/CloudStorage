...
/**
 * Class ilCloudStorageWebDavShareAPI
 *
...
class ilCloudStorageWebDavShareAPI
{
    ...
    public function __construct(Client $http_client, ilCloudStorageWebDav $a_dav)
    {
    ...
    /**
     * @return ilCloudStorageWebDavShare[]
    ...
    public function all() : array
    {
        ...
        if ($decoded->ocs->meta->status === 'ok') {
            ...
            foreach ($decoded->ocs->data as $std_class) {
                $shares[] = ilCloudStorageWebDavShare::loadFromStdClass($std_class);
            }
        }
        return $shares;
    }
     ...
     * @param string $path
     *
     * @return ilCloudStorageWebDavShares[]
     * @throws GuzzleException
     */
