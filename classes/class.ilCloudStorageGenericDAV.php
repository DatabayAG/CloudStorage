...
abstract class ilCloudStorageGenericDAV extends Client implements ilCloudStorageGenericService
{   
     ...
     */
    public function uploadFile($location, $local_file_path): bool
    {
